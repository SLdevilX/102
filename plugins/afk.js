...
Asena.addCommand({on: 'text', fromMe: false, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'afk ?(.*)', fromMe: true, deleteCommand: false, dontAddCommandList: true, desc: Lang.AFK_DESC}, (async (message, match) => {     
    if (!AFK.isAfk) {
